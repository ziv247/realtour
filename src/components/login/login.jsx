          ...
          <div>
            <div data-testid="login" className="sc-fzXfLR bAzGHq">
              <div className="sc-fzXfMA kyBnvO">
                <h2 data-testid="header-text" className="sc-fzXfLW bAzGHv">
                  Log in to your account
                </h2>
                <p data-testid="header-desc" className="sc-fzXfLX fHsYfH">
                  ...
                  <div className="sc-fzXfMx flXNtz">
                    <div>
                      <input
                        ...
                        data-testid="passwd-input-field"
                        className="sc-AykKD iZPqEB"
                      />
                    </div>
                  </div>
                  <div className="sc-fzXfNg bAzGIZ">
                    <a className="sc-AykKH jiZwia" href="/">
                      Forgot Password?{" "}
                    </a>
                  </div>
              ...
              <div className="sc-fzXfLU bAzGHt">
                <div className="sc-fzXfLV bAzGHu">
                  ...
                  <a
                    data-testid="pro-signup-link"
                    href=" https://dashboard.realtor.com/signup"
                  >
                    No professional account? Sign up here
                  </a>
                </div>
