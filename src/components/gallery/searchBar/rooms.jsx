            ...
            <Dropdown>
                ...
                <DropdownMenu style={{width: "max-content", paddingTop: 0, top: "3px"}}>
                    ...
                    <Container fluid={true}>
                        <Row>
                            <Col className={'radio checked'} id={"any"} data-value={"0"} onClick={(e) => this.onCheck(e,searchByNumber)}>
                                Any
                            </Col>
                            <Col className={'radio'} id={type+"1"} data-value={"1"} onClick={(e) => this.onCheck(e,searchByNumber)}>1+</Col>
                            <Col className={'radio'} id={type+"2"} data-value={"2"} onClick={(e) => this.onCheck(e,searchByNumber)}>2+</Col>
                            <Col className={'radio'} id={type+"3"} data-value={"3"} onClick={(e) => this.onCheck(e,searchByNumber)}>3+</Col>
                            <Col className={'radio'} id={type+"4"} data-value={"4"} onClick={(e) => this.onCheck(e,searchByNumber)}>4+</Col>
                        </Row>
                        <p style={{textAlign: "center"}}>Or Select Bedrooms Range</p>
                        <Row style={{justifyContent: "space-around"}}>
                            <select className={"btn"} style={{border:"1px solid"}} onChange={(event)=>this.onPickMin(event.target.value)}>
                            ...
                            <select className={"btn"} style={{border:"1px solid"}} onChange={(event)=>this.onPickMax(event.target.value,type,searchByNumber)}>
